...
const fetchUsers = async (
  ...
  const res = await fetch(
    `https://tender-online-h4lh.vercel.app/api/auth/users?page=${page}&limit=${limit}&search=${search || ""}`,
  );
...
const deleteUser = async (userId: string) => {
  const res = await fetch(
    `https://tender-online-h4lh.vercel.app/api/auth/users/${userId}`,
    {
      method: "DELETE",
    },
  );
...
const updateUserStatus = async (
  ...
  const res = await fetch(
    `https://tender-online-h4lh.vercel.app/api/auth/users/${userId}/status`,
    {
      method: "PATCH",
      headers: {
